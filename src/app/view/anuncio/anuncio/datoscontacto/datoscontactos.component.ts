...
export class DatosContactoComponent implements OnInit {
    ...
    constructor(private router: Router,
        private anuncioServioce: AnuncioService
    ) { }

    ngOnInit() {
        this.datoscontacto = this.anuncioServioce.getDatosContacto();

        this.anuncioServioce.segundopaso(false);
        this.anuncioServioce.tercerpaso(false);
        this.anuncioServioce.cuartopaso(false);
        this.anuncioServioce.quintopaso(false);
        //Controles Datos de Contacto
